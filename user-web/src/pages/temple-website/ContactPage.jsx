        ...
        <div className="contact-container">
          ...
          <div className="traffic-grid">
            <div className="traffic-card">
              ...
              <h4>自行開車</h4>
              <ul>
                <li>國道3號 → 名間交流道下 → 台3線往名間 → 依指標往松柏嶺</li>
                <li>國道1號 → 彰化交流道下 → 台14線往南投 → 接台3線往名間</li>
              </ul>
            </div>
            <div className="traffic-card">
              <div className="traffic-icon">
            ...
            <div className="booking-content">
              ...
              <div className="booking-info">
                <div className="booking-item">
                  ...
                  <span className="value">049-258-1008 轉 102</span>
                </div>
                <div className="booking-item">
                  <span className="label">傳真報名：</span>
                  <span className="value">049-258-1009</span>
                </div>
                <div className="booking-item">
